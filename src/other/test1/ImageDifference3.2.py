...
class DetectionModel(object):
    ...
    def detection(self, dataset, respath):
        ...
        for i in range(0, len(dataset)):
            ...
            resizeBaseImage, height_ratio1, width_ratio1 = self.resize(image=baseImage, dsize=(resize_width, resize_height))
            resizeTargetImage, height_ratio2, width_ratio2 = self.resize(image=targetImage, dsize=(resize_width, resize_height))
...
if __name__ == "__main__":
    ...
    model.detection(dataset, './result/')
    cv.waitKey(0)
