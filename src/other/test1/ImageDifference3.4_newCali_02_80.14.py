...
class DetectionModel(object):                                   # 2
    ...
    def morphology(self, image):
        kernel = cv.getStructuringElement(cv.MORPH_RECT, (3, 3))                        # cv.BORDER_REFLECT
...
if __name__ == "__main__":
    ...
    model = DetectionModel(0.6, 0.6, showImage=False, pause=False, nFeatures=2000, hugeImageThresh=360000,
                           normalBlurSize=0.015,
                           firstBlurSize=0.03, secondBlurSize=0.025,   # 25 15
                           normalThreshSize=3, normalThreshC=2.5,
                           hugeThreshSize=7, hugeThreshC=4     # 9 4.5   TODO:5 2.5
                           )
