...
if __name__ == "__main__":
    ...
    model = DetectionModel(0.3, 0.3, showImage=True, pause=True, nFeatures=2000, hugeImageThresh=200000, calibrate=True,
                           normalBlurSize=0.015,
                           firstBlurSize=0.025, secondBlurSize=0.014,   # 25 15
